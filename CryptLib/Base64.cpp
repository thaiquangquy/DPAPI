...
std::wstring CBase64::Utf8_To_Wstring(const std::string& str)
{
...
std::string CBase64::Wstring_To_Utf8(const std::wstring& str)
{
	std::wstring_convert<std::codecvt_utf8<wchar_t>> myconv;
	return myconv.to_bytes(str);
}

const unsigned char* CBase64::Convert(const std::string& s)
{
